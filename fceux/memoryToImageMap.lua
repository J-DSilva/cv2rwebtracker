-- memoryToImageMap.lua
-- Lua module version of the mapping used by fceux_poster.lua
return {
  ...
  { alt = "Garlic", addr = "0x0092", bit = 3, when = "set" },
  ...
  { alt = "The Laurel", addr = "0x0092", bit = 2, when = "set" },
